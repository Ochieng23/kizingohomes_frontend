...
/>
            ...
            <div className="absolute bottom-0 left-0 right-0 py-2 px-4 bg-black bg-opacity-50 text-white shadow-md flex">
              <div className='flex-start'><span className="text-bold ">{imageUrl.text}</span></div>
              <div className='flex-1'><p className='text-sm '>{imageUrl.description} </p></div>
              <div className='flex-1'><Link className='text-sm '><strong>View</strong></Link></div>
            </div>
