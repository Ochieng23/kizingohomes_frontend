      ...
      <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
        ...
        >
          ...
          <div>
            <Link
              to="/login"
              className="inline-block text-sm px-4 py-2 leading-none border rounded text-black-300 border-white hover:border-transparent hover:text-white-500 hover:bg-white mt-4 mr-2 lg:mt-0"
            >
              LOGIN
            </Link>
            <Link
