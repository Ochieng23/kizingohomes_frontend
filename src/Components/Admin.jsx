...
import ManageCsites from "./ManageCsites";
...
function Admin() {
  ...
  const [showManageCsites, setManageCsites] = useState(false);
  ...
  const handleDashboardClick = () => {
    ...
    setShowAddCs(false);
    setShowManageProperties(false);
    setManageCsites(false);
  ...
  const handleManagePropertiesClick = () => {
    ...
    setShowAddProperties(false);
    setShowAddCs(false);
    setShowManageProperties(true);
    setManageCsites(false);
    setShowInventory(false);
  };

  const handleManageSitesClick = () => {
    setShowDashboard(false);
    setShowAddProperties(false);
    setShowAddCs(false);
    setShowManageProperties(false);
    setManageCsites(true);
    setShowInventory(false);
  };
  ...
  return (
    <div>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-teal-600">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                onClick={handleManageSitesClick}
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-teal-600">
          {showDashboard && <Dashboard />}
          {showAddProperties && <AddProperties />}
          {showAddCs && <AddCs />}
          {showManageProperties && <ManageProperties />}
          {showManageCsites && <ManageCsites />}
